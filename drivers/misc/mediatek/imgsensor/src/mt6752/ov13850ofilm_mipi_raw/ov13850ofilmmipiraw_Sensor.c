...
#define PFX "OV13850OFILM_camera_sensor"
#define LOG_1 LOG_INF("OV13850OFILM,MIPI 4LANE\n")
...
//sensor otp
extern int ov13850ofilmr2a_update_eeprom();
extern bool ov13850ofilm_otp_check_mid(void);

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV13850OFILM_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
{
    return ((read_cmos_sensor(0x300A) << 8) | read_cmos_sensor(0x300B)+1);//ofilm sensor iD=0xd851
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    LOG_INF("ov13850ofilm get_imgsensor_id start\n");
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                check_mid=ov13850ofilm_otp_check_mid();
                if (!check_mid)
                {

...
/*Begin Lenovo-sw mahj2 add for protect usb connector 2015-01-06*/
#ifdef INPUT_CHARGER_CURRENT_LIMIT
	if(g_temp_input_CC_value > INPUT_CHARGER_CURRENT_LIMIT)
	{
		g_temp_input_CC_value = INPUT_CHARGER_CURRENT_LIMIT;
	}
#endif
/*End Lenovo-sw mahj2 add for protect usb connector 2015-01-06*/
		battery_xlog_printk(BAT_LOG_CRTI,
...
#else
			cv_voltage = BATTERY_VOLT_04_200000_V;
		  /* lenovo-sw zhangrc2 change cv to 4.35V 2014-08-27 end */			
#endif
			battery_charging_control(CHARGING_CMD_SET_CV_VOLTAGE, &cv_voltage);
#endif
		}

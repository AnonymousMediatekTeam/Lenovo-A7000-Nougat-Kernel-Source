...
/*lenovo sw: AIOROW-3569 begin*/
struct timeval g_tv_after_sleep;
time_t pre_after_sleep_tvsec = 0;
bool bat_update_sleep_timeout = false;
/*lenovo sw: AIOROW-3569 end*/
...
static int battery_meter_resume(struct platform_device *dev)
{
	...
	/*lenovo sw: AIOROW-3569 begin*/
	do_gettimeofday(&g_tv_after_sleep);
	/*lenovo sw: AIOROW-3569 end*/
	_g_bat_sleep_total_time += rtc_time_after_sleep.tv_sec - g_rtc_time_before_sleep.tv_sec;

	battery_xlog_printk(BAT_LOG_CRTI,
			    "[battery_meter_resume] sleep time = %d, g_spm_timer = %d , pre_sleep_tvsec:%ld,after_sleep_tvsec:%ld\n",
			    _g_bat_sleep_total_time, g_spm_timer,pre_after_sleep_tvsec,g_tv_after_sleep.tv_sec );
...
#endif
	/*lenovo sw: AIOROW-3569 begin*/
	if( (g_tv_after_sleep.tv_sec - pre_after_sleep_tvsec) > 300 )
	{
		bat_update_sleep_timeout = true;
		pre_after_sleep_tvsec = g_tv_after_sleep.tv_sec ;
	}
	/*lenovo sw: AIOROW-3569 end*/
...
/* lenovo-sw zhangrc2 optim ui_soc update time in long sleep end 2014-01-16 */  
